...
const Tile = (p: SkillsProps) => {
    return (
        <>
            <div className="text-center shadow-lg p-10 rounded-xl my-10  dark:bg-light flex-1">
                ...
                <h4 className="py-4 text-highlight-600">Design Tools I Use</h4>
    ...
    return (
        <>
            <section className='pad'>
                <div>
                    <h3 className="text-3xl py-1 dark:text-light ">Services I offer</h3>
